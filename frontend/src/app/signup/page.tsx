    ...
    try {
      const response = await fetch("http://127.0.0.1:8000/api/auth/signup", {
        ...
        body: JSON.stringify({
          ...
          email: email,
          password: password,
          role_targeting: experienceLevel || "Fresher",
          skills: [],
          target_companies: [],
          scheduled_time: "",
        }),
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <button
          ...
          onClick={() => alert("Google Auth coming soon. Please sign up with email.")}
        >
        ...
        <form onSubmit={handleSignup}>
          ...
          <div className="auth-field">
            <label className="auth-label" htmlFor="signup-experience">YOUR EXPERIENCE LEVEL</label>
      ...
      <footer className="auth-footer">
        <span className="auth-footer-text">
          By signing up, you agree to our <a href="#" className="auth-footer-link">Terms of Service</a> and <a href="#" className="auth-footer-link">Privacy Policy</a>.
        </span>
      </footer>
    </div>
  );
